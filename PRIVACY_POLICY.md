My PHStore: Privacy policy
Welcome to the My PHStore app for Android!

This is an open source Android app developed by Technopresso Group. The source code is available on GitHub under the MIT license; the app is also available on Google Play.
